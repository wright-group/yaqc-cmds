...
def grating_linear_dispersion(spec_inclusion_angle, spec_focal_length,
                              spec_focal_length_tilt, spec_grooves_per_mm,
                              spec_central_wavelength, spec_order,
                              number_of_pixels,
                              pixel_width, calibration_pixel):
    '''
    Parameters
    ----------
    ...
    # calculate terms
    x = np.arcsin((1e-6*spec_order*spec_grooves_per_mm*spec_central_wavelength)/(2*np.cos(spec_inclusion_angle_rad/2.)))
    A = np.sin(x-spec_inclusion_angle_rad/2)
    B = np.sin((spec_inclusion_angle_rad)+x-(spec_inclusion_angle_rad/2)-
                np.arctan((pixel_width_mm*(i_pixel-calibration_pixel)+spec_focal_length*spec_focal_length_tilt_rad)/(spec_focal_length*np.cos(spec_focal_length_tilt_rad))))
...
if __name__ == '__main__':
    arr = grating_linear_dispersion(spec_inclusion_angle=24.,
                                    spec_focal_length=140.,
                                    spec_focal_length_tilt=0.,
                                    spec_grooves_per_mm=300.,
                                    spec_central_wavelength=1300.,
                                    spec_order=1,
