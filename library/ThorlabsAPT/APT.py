...
class APTMotor():
    ...
    def _get_hardware_information(self):
        ...
        error = self.dll.GetHWInfo(serial_number, model, 255, softwareVersion, 255, hardwareNotes, 255)
    ...
    def _get_stage_axis_information(self):
        ...
        error = self.dll.MOT_GetStageAxisInfo(serial_number, ctypes.pointer(minimumPosition), ctypes.pointer(maximumPosition), ctypes.pointer(units), ctypes.pointer(pitch))
    ...
    def _get_velocity_parameters(self):
        ...
        error = self.dll.MOT_GetVelParams(serial_number, ctypes.pointer(minimumVelocity), ctypes.pointer(acceleration), ctypes.pointer(maximumVelocity))
    ...
    def _get_velocity_parameter_limits(self):
        ...
        maximumVelocity = ctypes.c_float()
        error = self.dll.MOT_GetVelParamLimits(serial_number, ctypes.pointer(maximumAcceleration), ctypes.pointer(maximumVelocity))
    ...
    def _set_velocity_parameters(self, minimum_velocity, acceleration, maximum_velocity):
        ...
        error = self.dll.MOT_SetVelParams(serial_number, minimumVelocity, acceleration, maximumVelocity)
        return error
