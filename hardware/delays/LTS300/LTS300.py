...
class app(wx.App):
    ...
    def initialize(self, inputs, address):
        ...
        # read from ini
        self.factor = pc.Number(ini=ini, section='main', option='factor', decimals=0, disable_under_queue_control=True)
        ...
        self.label = pc.String(ini=ini, section='main', option='label', disable_under_queue_control=True)
