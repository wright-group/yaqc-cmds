...
hardware_dict['OPA1 micro'] = [os.path.join(main_dir, 'hardware', 'OPAs', 'pico', 'pico_opa.py'), 'pico_opa', 'OPA', [1], 'w1']
...
hardware_dict['OPA4 TOPAS-800'] = [os.path.join(main_dir, 'hardware', 'OPAs', 'TOPAS_800', 'TOPAS.py'), 'TOPAS', 'OPA', [4], 'w4']
