...
ini = project.ini_handler.Ini(os.path.join(main_dir, 'coset', 'coset.ini'))
ini.return_raw = True
...
class CoSetHW:
    ...
    def add_table_row(self, corr):
        ...
        g.module_control.disable_when_true(button)
    ...
    def create_frame(self, layout):
        ...
        g.module_control.disable_when_true(self.use_bool)
        ...
        g.module_control.disable_when_true(self.add_button)
